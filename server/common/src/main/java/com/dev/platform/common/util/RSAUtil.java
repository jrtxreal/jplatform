...
public class RSAUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        genKeyPair();
        //加密字符串
        String message = "{\"username\":\"张三\",\"password\":\"admin\",\"loginType\":\"usernamepassword\",\"deviceType\":\"browser\"}";
