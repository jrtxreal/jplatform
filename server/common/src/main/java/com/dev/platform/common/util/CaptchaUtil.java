...
//        log.info("原图大小{} x {},随机生成的坐标 X,Y 为（{}，{}）", oriImageWidth, oriImageHeight, widthRandom, heightRandom);
        ...
        graphics.setStroke(new BasicStroke(BOLD, BasicStroke.CAP_ROUND, BasicStroke.JOIN_BEVEL));
...
//        pictureMap.put("slidingImage", newImagebyte);
//        pictureMap.put("backImage", oriImageByte);
...
//        File targetFile = new File("E:\\WORKHOME\\watcher_serv\\src\\main\\resources\\sliderimage\\targets\\1.jpg");
//        File tempImgFile = new File("E:\\WORKHOME\\watcher_serv\\src\\main\\resources\\sliderimage\\templates\\1-w.png");
//        Map map = pictureTemplatesCut(tempImgFile,targetFile);
//        byte[] slidingImages = (byte[]) map.get("slidingImage");
//
//        byte[] backImages = (byte[]) map.get("backImage");
//
//        FileImageOutputStream imageOutput = new FileImageOutputStream(new File("E:\\JPG\\bigImage.jpg"));
//        imageOutput.write(slidingImages,0,slidingImages.length);
//
//        FileImageOutputStream imageOutput1 = new FileImageOutputStream(new File("E:\\JPG\\smallImage.jpg"));
//        imageOutput1.write(backImages,0,backImages.length);
        Object o= "1a5";
        System.out.println(o2l(o));
    ...
    public static long o2l(Object o) {
        ...
        long l = 0L;
        try {
            l = Long.valueOf(String.valueOf(o));
